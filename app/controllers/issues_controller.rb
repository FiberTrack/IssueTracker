...
class IssuesController < ApplicationController
  ...
  before_action -> { authenticate_api_key(request.headers['Authorization'].present?) }, only: [:destroy, :create, :update, :create_comment, :block, :add_deadline, :delete_deadline, :create_multiple_issues]
